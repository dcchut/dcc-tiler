...
pub fn render_single_tiling(board : &RectangularBoard, tile_hashmap : &HashMap<RectangularBoard, Vec<RectangularBoard>>) -> String {
    ...
    Svg(vec![Fig::Multiple(boxes)], 50 * board.width as u32, 50 * board.height as u32).to_string()
}